...
use Drupal\billing\Entity\BillingEntity;


/**
 * Provides dynamic permissions for Billing of different types.
 *
 * @ingroup billing
 *
 */
class BillingEntityPermissions{
   ...
   *
   * @return array
   *   The BillingEntity by bundle permissions.
   *   @see \Drupal\user\PermissionHandlerInterface::getPermissions()
   */
  public function generatePermissions() {
    $perms = [];

    foreach (BillingEntity::loadMultiple() as $type) {
   ...
   *
   * @param \Drupal\billing\Entity\BillingEntity $type
   *   The BillingEntity type.
   *
   * @return array
   *   An associative array of permission names and descriptions.
   */
  protected function buildPermissions(BillingEntity $type) {
    $type_id = $type->id();
